...
filename = '10steps_Pme.txt'
f1 = open(filename, 'w')
filename = '10steps_Pem.txt'
f2 = open(filename, 'w')
filename = '10steps_Pme_r.txt'
f3 = open(filename, 'w')
filename = '10steps_Pem_r.txt'
f4 = open(filename, 'w')
...
def U_multiply(matrix1, matrix2, matrix3, matrix4,matrix5, matrix6,matrix7, matrix8,matrix9, matrix10,flavors):#matrix11, matrix12,matrix13, matrix14,matrix15, matrix16,matrix17, matrix18,matrix19, matrix20,flavors):
    from sympy import sin, cos, symbols
    from numpy.linalg import eig
    U1_matrix = matrix1
    U2_matrix = matrix2
...
#    k18= np.dot(U19_matrix,k17)
 #   k19= np.dot(U20_matrix,k18)
    ...
    U_total = k9#np.dot(U2_matrix,U1_matrix)
    return(U_total)
...
for nu in range(N):
    ...
    Unitary1[nu] = Unitary_matrix(EE[nu], types, vv[0], 200)     
    Unitary2[nu] = Unitary_matrix(EE[nu], types, vv[1], 200)
    Unitary3[nu] = Unitary_matrix(EE[nu], types, vv[2], 200)
    Unitary4[nu] = Unitary_matrix(EE[nu], types, vv[3], 200)
    Unitary5[nu] = Unitary_matrix(EE[nu], types, vv[4], 200)
    Unitary6[nu] = Unitary_matrix(EE[nu], types, vv[5], 200)
    Unitary7[nu] = Unitary_matrix(EE[nu], types, vv[6], 200)
    Unitary8[nu] = Unitary_matrix(EE[nu], types, vv[7], 200)
    Unitary9[nu] = Unitary_matrix(EE[nu], types, vv[8], 200)
    Unitary10[nu] = Unitary_matrix(EE[nu], types, vv[9], 200)
...
#    Unitary17[nu] = Unitary_matrix(EE[nu], types, vv[16], 100)
 ...
 #       Unitary1[nu][numU] = Unitary_matrix(EE[nu], types, V[numU], LL[numU])
    ...
    Unitary_total[nu] = U_multiply(Unitary1[nu],Unitary2[nu],Unitary3[nu],Unitary4[nu],Unitary5[nu],Unitary6[nu],Unitary7[nu],Unitary8[nu],Unitary9[nu],Unitary10[nu],types)#Unitary11[nu],Unitary12[nu],Unitary13[nu],Unitary14[nu],Unitary15[nu],Unitary16[nu],Unitary17[nu],Unitary18[nu],Unitary19[nu],Unitary20[nu],types)
...
#    Unitary_total[nu][numU] = U_multiply(Unitary1[nu][numU+1],Unitary2[nu][numU],types)
    ...
    Unitary_total_reversed[nu] = U_multiply(Unitary10[nu],Unitary9[nu],Unitary8[nu],Unitary7[nu],Unitary6[nu],Unitary5[nu],Unitary4[nu],Unitary3[nu],Unitary2[nu],Unitary1[nu],types)#Unitary10[nu],Unitary9[nu],Unitary8[nu],Unitary7[nu],Unitary6[nu],Unitary5[nu],Unitary4[nu],Unitary3[nu],Unitary2[nu],Unitary1[nu],types)#U_multiply(Unitary2[nu],Unitary1[nu],types)
...
#print(Pme,file=f1)
#print(Pem,file=f2)
#print(Pme_reversed,file=f3)
#print(Pem_reversed,file=f4)
"""
...
plt.title("A(L)= 0.0001+0.00002*L ",fontsize=10)
plt.xlabel('                                  L (km)')
plt.ylabel('                                  A(L)')
#plt.legend(fontsize=10)
